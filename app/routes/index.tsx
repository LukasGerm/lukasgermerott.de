      ...
      <Grid className="h-full overflow-y-hidden">
        <GridItem className="xl:col-span-4 col-span-6">
          <Container className="lg:px-24">
            ...
            >
              {t("Change the Web through quality Software")}
            </Typography>
            <Typography
              variant="h2"
            ...
            >
              {t(
                "I want to help make the web a better and more useable place for all of us with my knowledge and my ideas. Read about my journeys and find useful tips below on my blog."
              )}
            </Typography>
